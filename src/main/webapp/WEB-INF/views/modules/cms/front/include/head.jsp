...
<meta name="author" content="http://cd.iteye.com"/><meta http-equiv="X-UA-Compatible" content="IE=7,IE=9,IE=10" />
...
<c:if test="${site.theme eq 'basic'}">
	...
	<link href="${ctxStatic}/common/ums.min.css" type="text/css" rel="stylesheet" />
